...
<h2>Other plugins</h2>
    <p class="description">
◾ <?php _e('Improve your restaurant’s turnaround time by allowing the clients to call a waiter using their smart phones. Create a mobile web page with our QR Code Waiter Calling System plugin.', 'redi-restaurant-reservation'); ?> <a href="http://wordpress.org/plugins/qr-code-waiter-calling-system/" target="_blank">Open QR Code Waiter Calling System plugin</a><br/>
</p>
</div>