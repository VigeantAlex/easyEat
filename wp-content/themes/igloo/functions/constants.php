...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'igloo');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Igloo');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://www.cssigniter.com/support/viewtopic.php?f=55');
