...
function ci_register_theme_scripts()
{
	...
	wp_register_script( 'jRespond', get_child_or_parent_file_uri( '/js/jRespond.min.js' ), array( 'jquery' ), CI_THEME_VERSION, true );
	wp_register_script( 'jpanelmenu', get_child_or_parent_file_uri( '/js/jquery.jpanelmenu.min.js' ), array( 'jquery' ), CI_THEME_VERSION, true );
	wp_register_script( 'equalHeights', get_child_or_parent_file_uri( '/js/jquery.equalHeights.js' ), array( 'jquery' ), CI_THEME_VERSION, true );
